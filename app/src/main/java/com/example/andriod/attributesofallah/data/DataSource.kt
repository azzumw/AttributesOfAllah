...
class DataSource {
        ...
        return listOf(
                Attribute(english = R.string.eng_ar_rahman, transliteration = R.string.trans_ar_rahman, arabic = R.string.ar_rahman,R.drawable.ar_rahman),
                Attribute(english = R.string.eng_ar_raheem, transliteration = R.string.trans_ar_raheem , arabic = R.string.ar_raheem,R.drawable.ar_raheem),
//                Attribute(english = R.string.eng_al_malik, transliteration = R.string.trans_al_malik, arabic = R.string.al_malik,R.drawable.al_malik),
//                Attribute(english = R.string.eng_al_quddus, transliteration = R.string.trans_al_quddus, arabic = R.string.al_quddus,R.drawable.qudus),
//                Attribute(english = R.string.eng_as_salaam, transliteration = R.string.trans_as_salaam, arabic = R.string.as_salaam,R.drawable.al_maani),
//                Attribute(english = R.string.eng_al_mumin, transliteration = R.string.trans_al_mumin, arabic = R.string.al_mumin,R.drawable.al_mumin),
//                Attribute(english = R.string.eng_al_muhaymin, transliteration = R.string.trans_muhaymin,R.string.al_muhaymin,R.drawable.al_muhaymin),
                Attribute(english = R.string.eng_al_azeez, transliteration = R.string.trans_al_azeez, arabic = R.string.al_azeez,R.drawable.al_azeez),
//                Attribute(english = R.string.eng_al_jabaar, transliteration = R.string.trans_al_jabaar, arabic = R.string.al_jabaar,R.drawable.al_jabaar),
//                Attribute(english = R.string.eng_al_mutakabir, transliteration = R.string.trans_al_mutakabir,R.string.al_mutakabir,R.drawable.mutaqabir),
...
//                Attribute(english = R.string.eng_al_fattah, transliteration = R.string.trans_al_fattah, arabic = R.string.al_fattah),
                Attribute(english = R.string.eng_al_aleem, transliteration = R.string.trans_al_aleem, arabic = R.string.al_aleem,R.drawable.al_aleem),
                Attribute(english = R.string.eng_al_qaabid, transliteration = R.string.trans_al_qaabid, arabic = R.string.al_qaabid,R.drawable.al_qaabid),
//
...
//                Attribute(english = R.string.eng_ar_raafi, transliteration = R.string.trans_ar_raafi, arabic = R.string.ar_raafi),
                Attribute(english = R.string.eng_al_muizz, transliteration = R.string.trans_al_muizz, arabic = R.string.al_muizz,R.drawable.al_muiz),
...
//                Attribute(english = R.string.eng_as_samee, transliteration = R.string.trans_as_samee, arabic = R.string.as_samee),
                Attribute(english = R.string.eng_al_baseer, transliteration = R.string.trans_al_baseer, arabic = R.string.al_baseer,R.drawable.al_baseero),
...
//                Attribute(english = R.string.eng_al_khabeer, transliteration = R.string.trans_al_khabeer, arabic = R.string.al_khabeer),
                Attribute(english = R.string.eng_al_haleem, transliteration = R.string.trans_al_haleem, arabic = R.string.al_haleem,R.drawable.al_haleem),
...
//                Attribute(english = R.string.eng_al_alee, transliteration = R.string.trans_al_alee, arabic = R.string.al_alee),
                Attribute(english = R.string.eng_al_kabeer, transliteration = R.string.trans_al_kabeer, arabic = R.string.al_kabeer,R.drawable.al_kabeer),
                Attribute(english = R.string.eng_al_hafeedh, transliteration = R.string.trans_al_hafeedh, arabic = R.string.al_hafeedh,R.drawable.al_hafeez),
...
//                Attribute(english = R.string.eng_ar_raqeeb, transliteration = R.string.trans_ar_raqeeb, arabic = R.string.ar_raqeeb),
                Attribute(english = R.string.eng_al_mujeeb, transliteration = R.string.trans_al_mujeeb, arabic = R.string.al_mujeeb,R.drawable.al_mujeeb),
...
//
                Attribute(english = R.string.eng_al_haqq, transliteration = R.string.trans_al_haqq, arabic = R.string.al_haqq,R.drawable.al_haq),
...
//                Attribute(english = R.string.eng_al_mateen, transliteration = R.string.trans_al_mateen, arabic = R.string.al_mateen),
                Attribute(english = R.string.eng_al_waliyy, transliteration = R.string.trans_al_waliyy, arabic = R.string.al_waliyy,R.drawable.al_walee),
...
//
                Attribute(english = R.string.eng_al_mumeet, transliteration = R.string.trans_al_mumeet, arabic = R.string.al_mumeet,R.drawable.al_mumeet),
//                Attribute(english = R.string.eng_al_hayy, transliteration = R.string.trans_al_hayy, arabic = R.string.al_hayy),
                Attribute(english = R.string.eng_al_qayyoom, transliteration = R.string.trans_al_qayyoom, arabic = R.string.al_qayyoom,R.drawable.al_qayoom),
...
//                Attribute(english = R.string.eng_al_aakhir, transliteration = R.string.trans_al_aakhir, arabic = R.string.al_aakhir),
                Attribute(english = R.string.eng_az_zawhir, transliteration = R.string.trans_az_zawhir, arabic = R.string.az_zawhir,R.drawable.az_zawhir),
...
//                Attribute(english = R.string.eng_al_mugni, transliteration = R.string.trans_al_mugni, arabic = R.string.al_mugni),
                Attribute(english = R.string.eng_al_maani, transliteration = R.string.trans_al_maani,arabic = R.string.al_maani,R.drawable.al_maani),
//
...
//                Attribute(english = R.string.eng_an_naafi,R.string.trans_an_naafi,R.string.an_naafi),
                Attribute(english = R.string.eng_an_noor, transliteration = R.string.trans_an_noor, arabic = R.string.an_noor,R.drawable.an_noor),
...
//                Attribute(english = R.string.eng_al_baaqee, transliteration = R.string.trans_al_baaqee, arabic = R.string.al_baaqee,R.drawable.al_baaqee),
